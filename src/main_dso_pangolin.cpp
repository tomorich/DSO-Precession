...
int main( int argc, char** argv )
{
    ...
    std::ofstream out("Wresult3.txt");
    std::ofstream out2("result55.txt");
	// hook crtl+C.
  ...
  {std::cout<< reader->getTimestamp(i)<<std::endl;}
  sleep(10);*/
...
//Vec3 * WW1= new Vec3 ;
        ...
        for(int ii=0;ii<(int)idsToPlay.size(); ii++)
        {
            ...
            if (ii>35) {
                Vec3 W=fullSystem->calcuW();
                Vec3 ttt=fullSystem->print();
                out2<< ttt(0)<<" "<<ttt(1)<<" "<<ttt(2)<<std::endl;
                //out << W(0) << " " << W(1) << " " << W(2) <<" " << sqrt(W(0)*W(0)+W(1)*W(1)+W(2)*W(2)) <<std::endl;
            }
            std::cout<<"ii " <<ii;
            //if(ii==200){sleep(1000);}
            if (ii>35){
           //     Vec6 abc=fullSystem->calcuRa();
            //out << abc(0) << " " << abc(1) << " " << abc(2)<<" "<< abc(3) << " " << abc(4) << " " << abc(5)<<std::endl
            ;}
        }
        finish=clock();
        ...
        fullSystem->printResult("result2.txt");
        //std::cout<< fullSystem->
